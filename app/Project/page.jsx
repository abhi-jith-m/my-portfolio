              ...
              return (
                ...
                >
                  ...
                  >
                    {/* CARD DESIGN */}
                    <Card
                      className={`w-[340px] h-[500px] rounded-xl overflow-hidden shadow-xl transition-all duration-300 ${
                    ...
                    >
                      ...
                      <CardContent className="p-5 bg-white dark:bg-gray-900 flex flex-col h-[calc(100%-14rem)]">
                        {/* Description */}
                        <div className="overflow-auto hide-scrollbar flex flex-col gap-4 max-h-full">
                          {/* Description */}
                          <div className="overflow-auto mb-1.5 custom-scrollbar flex flex-col gap-4 max-h-full pr-1">
                            {/* Description */}
